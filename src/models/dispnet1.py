...
class NNModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv3a = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=5, stride=2, padding=(1,2))
        ...
        self.conv5a = nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=2, padding=(2,1))
        ...
        self.up5to4 = nn.ConvTranspose2d(in_channels=1, out_channels=1, kernel_size=4, stride=2, padding=(2,1))
        self.upconv4 = nn.ConvTranspose2d(in_channels=512, out_channels=256, kernel_size=4, stride=2, padding=(2,1))
        ...
        self.up3to2 = nn.ConvTranspose2d(in_channels=1, out_channels=1, kernel_size=4, stride=2, padding=(0,1))
        self.upconv2 = nn.ConvTranspose2d(in_channels=128, out_channels=64, kernel_size=4, stride=2, padding=(0,1))
